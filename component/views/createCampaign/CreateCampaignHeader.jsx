...
const CreateCampaignHeader = ({title,NFTType,clearAll,addNFT,onClearAll,onAddNFT,HeaderNftType}) => {
  return (
...
{HeaderNftType && <Text bg='rgba(49, 102, 239, 0.1)' borderRadius={'1.5rem'} padding= '0.75rem 1.063rem' color={'#3166EF'} fontSize={'0.875rem'} fontWeight={400}>{HeaderNftType}</Text>}
</Flex>
